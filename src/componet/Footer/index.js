        ...
        <>
                ...
                <div className="row bg-dark mt-3">
                    ...
                    <div className="col-2 m-3 text-justify">
                        ...
                        <hr className="text-white"></hr>
                        <ul className="nav flex-column">
                            <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted">Our Store</a></li>
                            <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted">Delivery Information</a></li>
                            <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted">Term & Conditions</a></li>
                    ...
                    <h5 className="text-white">MY ACCOUNT</h5>
                        ...
                        <ul className="nav flex-column">
                            ...
                            <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted">Take Order</a></li>
                    ...
                    <div className="col-2 m-3">
                        ...
                        <hr className="text-white"></hr>
                         ...
                         <ul className="nav flex-column">
                            <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted"><i className="fa fa-home"></i>Rajkot,Gujarat,India</a></li>
                            <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted"><i className="fa fa-phone"></i>+91 9876543210</a></li>
                            <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted"><i className="fa fa-envelope"></i>shoecorner@gmail.com</a></li>
                    ...
                    <div className="col-2 m-3">
                        ...
                        <hr className="text-white"></hr>
                         ...
                         <ul className="nav flex-column">
                            <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted"><i className="fa fa-facebook"></i></a></li>
                            <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted"><i className="fa fa-twitter"></i></a></li>
                            <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted"><i className="fa fa-linkedin"></i></a></li>
