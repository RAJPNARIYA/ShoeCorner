                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src={slider1} className="d-block w-100" alt="slider" />
                            ...
                            <h1>Hot Trends of This Year<br />
                            <img src={line} alt="Image 1" /><br/>
                            <span className="btn bg-info" >Shop Now</span></h1>
                    ...
                    <div className="carousel-item">
                        <img src={slider2} className="d-block w-100" alt="..." />
                            <div className="carousel-caption d-none d-md-block">
                            <h1>New stylish shoes for men and women<br />
                            <img src={line} alt="Image 1" /><br/>
                            <span className="btn bg-info" >Shop Now</span></h1>
                    ...
                    <div className="carousel-item">
                        <img src={slider3} className="d-block w-100" alt="..." />
                            <div className="carousel-caption d-none d-md-block">
                            <h1>New stylish shoes for men<br />
                            <img src={line} alt="Image 1" /><br/>
                            <span className="btn bg-info" >Shop Now</span></h1>
                                <h3>Hot Trends of This Year</h3>
                            </div>
